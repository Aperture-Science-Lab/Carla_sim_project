...
import numpy as np
import csv
# MODIFIED: Commented out matplotlib
...
# MODIFIED: Commented out live_plotter
...
def store_trajectory_plot(graph, fname):
    ...
    """
    # MODIFIED: Bypassing plotting function
    return
...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        # MODIFIED: Entire plotting setup section commented out
        # #############################################
        ...
        for frame in range(TOTAL_EPISODE_FRAMES):
            ...
            # MODIFIED: All live plotting calls in the main loop are commented out
        ...
        # MODIFIED: All plot saving calls are commented out
        ...
        # This is the most important output, which is kept.
